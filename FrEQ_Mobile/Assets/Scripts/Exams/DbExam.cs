...
public class DbExam : MonoBehaviour
{
    ...
    void UpdateScores()
    {
        ...
        else if (glbScr.appTestID == "Y3EQDB_T2")
        {
        ...
        else if (glbScr.appTestID == "Y3EQDB_T3")
        {
        ...
        else if (glbScr.appTestID == "Y3EQDB_T4")
        {
        ...
        else if (glbScr.appTestID == "Y3EQDB_T5")
        {
        ...
        else if (glbScr.appTestID == "Y3EQDB_T6")
        {
