...
public class m4_lessonButtons : MonoBehaviour
{
    ...
    public void m4_Intro_Click()
    {
        glbScr.lessonID = "M4_I";
        PlayerPrefs.SetInt("lastScene", SceneManager.GetActiveScene().buildIndex);
        SceneManager.LoadScene(9);
    }
    public void m4_l1_Click()
    {
