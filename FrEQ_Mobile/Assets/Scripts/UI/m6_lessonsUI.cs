...
public class m6_lessonsUI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        UnlockButtons();
        m1scoreText.text = "Test score " + glbScr.M6EQDB_T1_Score + " out of 20";
        m2scoreText.text = "Test score " + glbScr.M6EQDB_T2_Score + " out of 20";
        m3scoreText.text = "Test score " + glbScr.M6EQDB_T3_Score + " out of 40";
        m4scoreText.text = "Test score " + glbScr.M6EQDB_T4_Score + " out of 20";
        m5scoreText.text = "Test score " + glbScr.M6EQDB_T5_Score + " out of 20";
        m6scoreText.text = "Test score " + glbScr.M6EQDB_T6_Score + " out of 40";
    }

    void UnlockButtons()
    {
        if (glbScr.m6eqDb_passedTests == 0f)
        {
        ...
        else if (glbScr.m6eqDb_passedTests == 1f)
        {
            m1lockText.text = "Click to begin.";
        ...
        else if (glbScr.m6eqDb_passedTests == 2f)
        {
            m1lockText.text = "Click to begin.";
            m2lockText.text = "Click to begin.";
        ...
        else if (glbScr.m6eqDb_passedTests == 3f)
        {
            m1lockText.text = "Click to begin.";
            m2lockText.text = "Click to begin.";
            m3lockText.text = "Click to begin.";
        ...
        else if (glbScr.m6eqDb_passedTests == 4f)
        {
            m1lockText.text = "Click to begin.";
            m2lockText.text = "Click to begin.";
            m3lockText.text = "Click to begin.";
        ...
        else if (glbScr.m6eqDb_passedTests == 5f)
        {
            m1lockText.text = "Click to begin.";
            m2lockText.text = "Click to begin.";
            m3lockText.text = "Click to begin.";
        ...
        else if (glbScr.m6eqDb_passedTests == 6f)
        {
            m1lockText.text = "Click to begin.";
            m2lockText.text = "Click to begin.";
            m3lockText.text = "Click to begin.";
