...
public class m2_LessonUI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        UnlockButtons();
        m1scoreText.text = "Test score " + glbScr.M2FX_T1_Score + " out of 8";
        m2scoreText.text = "Test score " + glbScr.M2FX_T2_Score + " out of 8";
        m3scoreText.text = "Test score " + glbScr.M2FX_T3_Score + " out of 8";
        m4scoreText.text = "Test score " + glbScr.M2FX_T4_Score + " out of 8";
        m5scoreText.text = "Test score " + glbScr.M2FX_T5_Score + " out of 8";
        m6scoreText.text = "Test score " + glbScr.M2FX_T6_Score + " out of 8";
    }
    void UnlockButtons()
    {
        if (glbScr.m2fx_passedTests == 0f)
        {
        ...
        else if (glbScr.m2fx_passedTests == 1f)
        {
            m1lockText.text = "Click to begin.";
        ...
        else if (glbScr.m2fx_passedTests == 2f)
        {
            m1lockText.text = "Click to begin.";
            m2lockText.text = "Click to begin.";
        ...
        else if (glbScr.m2fx_passedTests == 3f)
        {
            m1lockText.text = "Click to begin.";
            m2lockText.text = "Click to begin.";
            m3lockText.text = "Click to begin.";
        ...
        else if (glbScr.m2fx_passedTests == 4f)
        {
            m1lockText.text = "Click to begin.";
            m2lockText.text = "Click to begin.";
            m3lockText.text = "Click to begin.";
        ...
        else if (glbScr.m2fx_passedTests >= 5f)
        {
            m1lockText.text = "Click to begin.";
            m2lockText.text = "Click to begin.";
            m3lockText.text = "Click to begin.";
