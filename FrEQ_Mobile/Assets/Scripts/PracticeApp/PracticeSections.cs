...
public class PracticeSections : MonoBehaviour
{
    ...
    public void ChangePracticeSections()
    {
        ...
        if (glbScr.cutOrBoost == "Both" && glbScr.pinkOrMusic == "PN")
        {
            ...
            scrollRect.sizeDelta = new Vector2(scrollRect.sizeDelta.x, 770f);
        }
        else if (glbScr.cutOrBoost == "Both" && glbScr.pinkOrMusic == "MUS")
        {
            ...
            scrollRect.sizeDelta = new Vector2(scrollRect.sizeDelta.x, 550f);
        }
        else if (glbScr.cutOrBoost != "Both" && glbScr.pinkOrMusic == "PN")
        {
            ...
            scrollRect.sizeDelta = new Vector2(scrollRect.sizeDelta.x, 1050f);
        }
        else if (glbScr.cutOrBoost != "Both" && glbScr.pinkOrMusic == "MUS")
        {
            cutBoostSec.SetActive(false);
            ...
            scrollRect.sizeDelta = new Vector2(scrollRect.sizeDelta.x, 870f);
        }
    }
}
