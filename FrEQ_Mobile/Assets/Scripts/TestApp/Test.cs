...
public class Test : MonoBehaviour
{
    ...
    void ButtonActivations()
    {
        ...
        buttonHolder.transform.GetComponent<RectTransform>().sizeDelta = new Vector2(buttonHolder.transform.GetComponent<RectTransform>().sizeDelta.x, 120 * buttonCount);
    ...
    void UpdateScores()
    {
        ...
        else if (glbScr.appTestID == "M5EQ_T2")
        {
            ...
            {
                glbScr.M5EQ_T2_Score = score;
            }
        }
        else if (glbScr.appTestID == "M5EQ_T3")
        {
            if (score > glbScr.M5EQ_T3_Score)
            {
